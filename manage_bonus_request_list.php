                  ...
                  <div class="panel tabbed-panel panel-info">
                     ...
                     <div class="panel-body p-0">
                        ...
                        <?php
                            ...
                            $bnsQry = mysqli_query($con,"SELECT a.id as ids,a.created_on as created_at,a.*,b.*,c.*,c.id as empIds,d.* FROM hr_bonus_request a, master_type_dtls b, mstr_emp c, prj_organisation d WHERE a.b_type=b.mstr_type_value AND a.created_by=c.id AND a.org_id=d.id AND a.b_id IN (SELECT id FROM `hr_bonus` WHERE b_status=1) AND (a.b_status='0' || a.b_status='2') GROUP BY a.b_id ORDER BY a.id DESC");
                        ...
                        <?php
                            ...
                            $bnsQry = mysqli_query($con,"SELECT a.id as ids,a.created_on as created_at,a.*,b.*,c.*,c.id as empIds,d.* FROM hr_bonus_request a, master_type_dtls b, mstr_emp c, prj_organisation d WHERE a.b_type=b.mstr_type_value AND a.created_by=c.id AND a.org_id=d.id AND a.b_id IN (SELECT id FROM `hr_bonus` WHERE b_status=1) AND a.b_status='3' GROUP BY a.b_id ORDER BY a.id DESC");
                            $bnsQry_results = mysqli_num_rows($bnsQry);
                            if ($bnsQry_results>0) {
                                $counter=0;
                                while($rows=mysqli_fetch_object($bnsQry)){
                        ...
                        <?php
                            ...
                            $bnsQry = mysqli_query($con,"SELECT a.id as ids,a.created_on as created_at,a.*,b.*,c.*,c.id as empIds,d.* FROM hr_bonus_request a, master_type_dtls b, mstr_emp c, prj_organisation d WHERE a.b_type=b.mstr_type_value AND a.created_by=c.id AND a.org_id=d.id AND a.b_id IN (SELECT id FROM `hr_bonus` WHERE b_status=1) AND a.b_status='4' GROUP BY a.b_id ORDER BY a.id DESC");
                            $bnsQry_results = mysqli_num_rows($bnsQry);
                            if ($bnsQry_results>0) {
                                $counter=0;
                                while($rows=mysqli_fetch_object($bnsQry)){
